...
//            System.out.println("Excluded Cross-talk channel for PMT: 378 with Pixels: 42, 50 and PMT: 379 with Pixels: 29 and 30");
    ...
    private int PMT1[]={1,4,7,9,12,14,17,19,22,25,28,31,33,36,39,41,44,47,50,52,55,58,61,64,66,69,72,75,77,80,83,86,89,91,94,97,100,
    ...
    private int PMT2[]={2,5,0,10,0,15,0,20,23,26,29,0,34,37,0,42,45,48,0,53,56,59,62,0,67,70,73,0,78,81,84,87,0,92,95,98,101,104,0,
    ...
    private int PMT3[]={3,6,8,11,13,16,18,21,24,27,30,32,35,38,40,43,46,49,51,54,57,60,63,65,68,71,74,76,79,82,85,88,90,93,96,99,102,
    ...
    private int chan2pix[] = {60, 58, 59, 57, 52, 50, 51, 49, 44, 42, 43, 41, 36, 34, 35, 33, 28, 26, 27, 25, 20, 18, 19, 17, 12, 10, 
